...
for block in range(3):
    for branch in range(3):
        replace_dict['bn2' + alphabet[block] + '_branch2' + alphabet[branch]] = 'fpn.C2.' + str(block) + '.bn' + str(
            branch + 1)
        replace_dict['res2' + alphabet[block] + '_branch2' + alphabet[branch]] = 'fpn.C2.' + str(block) + '.conv' + str(
            branch + 1)
...
for block in range(4):
    for branch in range(3):
        replace_dict['bn3' + alphabet[block] + '_branch2' + alphabet[branch]] = 'fpn.C3.' + str(block) + '.bn' + str(
            branch + 1)
        replace_dict['res3' + alphabet[block] + '_branch2' + alphabet[branch]] = 'fpn.C3.' + str(block) + '.conv' + str(
            branch + 1)
...
for block in range(23):
    for branch in range(3):
        replace_dict['bn4' + alphabet[block] + '_branch2' + alphabet[branch]] = 'fpn.C4.' + str(block) + '.bn' + str(
            branch + 1)
        replace_dict['res4' + alphabet[block] + '_branch2' + alphabet[branch]] = 'fpn.C4.' + str(block) + '.conv' + str(
            branch + 1)

for block in range(3):
    for branch in range(3):
        replace_dict['bn5' + alphabet[block] + '_branch2' + alphabet[branch]] = 'fpn.C5.' + str(block) + '.bn' + str(
            branch + 1)
        replace_dict['res5' + alphabet[block] + '_branch2' + alphabet[branch]] = 'fpn.C5.' + str(block) + '.conv' + str(
            branch + 1)
